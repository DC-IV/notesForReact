...
### Понятия и Термины
###### Принцип единственно ответственности (The Single Responsibility Principle, SRP)
  Это принцип ООП означающий, что каждый объект должен иметь одну ответсвенность и причину существования.
###### Чистая функция
...
###### Колбэк-функция или функция обратного вызова
Предназначена для отложенного выполнения.
```jsx
